...
planet_dynamics = read_vplanet(os.path.join('parameter_sweeps', 'sun_atm_1_au_withF', 'sol.earth.forward'))
save_path = os.path.join(os.pardir, 'plots', 'sun_atm_1_au_withF.png')
