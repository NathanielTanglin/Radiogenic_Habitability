...
@benchmark(
    {
        ...
        "log.initial.gl514.SurfEnFluxTotal": {
            "value": 5.6927005838186184e-10,
            "unit": u.kg / u.sec**3,
        },
        "log.initial.gl514.TidalQ": {"value": 1.0000000000000000e06},
        ...
        "log.initial.gl514.DRotRateDtEqtide": {
            "value": -2.1346978387088952e-32,
            "unit": 1 / u.sec**2,
        },
        "log.initial.gl514.EqRotRateDiscrete": {
            "value": 7.7800437205935984e-07,
            "unit": 1 / u.sec,
        },
        "log.initial.gl514.EqRotPerDiscrete": {
            "value": 8.0760282754557505e06,
            "unit": u.sec,
        },
        "log.initial.gl514.EqRotRateCont": {
            "value": 1.5164601885390357e-06,
            "unit": 1 / u.sec,
        },
        "log.initial.gl514.EqRotPerCont": {
            "value": 4.1433236128887986e06,
            "unit": u.sec,
        },
        "log.initial.gl514.EqRotPer": {"value": 4.1433236128887986e06, "unit": u.sec},
        ...
        "log.initial.gl514b.DOblDtEqtide": {
            "value": 3.4502716517739296e-17,
            "unit": u.rad / u.sec,
        },
        "log.initial.gl514b.DRotPerDtEqtide": {"value": 3.7660240995856781e-11},
        "log.initial.gl514b.DRotRateDtEqtide": {
            "value": -3.1698264008113854e-20,
            "unit": 1 / u.sec**2,
        },
        "log.initial.gl514b.EqRotRateDiscrete": {
            "value": 7.7800437205935984e-07,
            "unit": 1 / u.sec,
        },
        "log.initial.gl514b.EqRotPerDiscrete": {
            "value": 8.0760282754557505e06,
            "unit": u.sec,
        },
        "log.initial.gl514b.EqRotRateCont": {
            "value": 1.5164601885390357e-06,
            "unit": 1 / u.sec,
        },
        "log.initial.gl514b.EqRotPerCont": {
            "value": 4.1433236128887986e06,
            "unit": u.sec,
        },
        ...
        "log.final.gl514.SurfEnFluxTotal": {
            "value": 5.6927005606372457e-10,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.gl514.TidalQ": {"value": 1.0000000000000000e06, "rtol": 1e-4},
        ...
        "log.final.gl514.DRotPerDtEqtide": {
            "value": 2.3670446957670787e-20,
            "rtol": 1e-4,
        },
        "log.final.gl514.DRotRateDtEqtide": {
            "value": -2.1346978387082093e-32,
            "unit": 1 / u.sec**2,
            "rtol": 1e-4,
        },
        "log.final.gl514.EqRotRateDiscrete": {
            "value": 7.7800437205928784e-07,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514.EqRotPerDiscrete": {
            "value": 8.0760282754564984e06,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514.EqRotRateCont": {
            "value": 1.5164601885389768e-06,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514.EqRotPerCont": {
            "value": 4.1433236128889597e06,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514.GammaRot": {
            "value": -1.0000000000000000,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514.GammaOrb": {
            "value": -1.0000000000000000,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.Zobl": {"value": 0.9170600739556315, "rtol": 1e-4},
        ...
        "log.final.gl514b.MeanMotion": {
            "value": 5.1866958137285860e-07,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.OrbPeriod": {
            "value": 1.2114042413184749e07,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.SemiMajorAxis": {
            "value": 6.3130301435403900e10,
            "unit": u.m,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.OrbPotEnergy": {
            "value": -3.3292681791378085e34,
            "unit": u.Joule,
            "rtol": 1e-4,
        },
        "log.final.gl514b.LostEnergy": {
            "value": 1.0028690689225319e23,
            "unit": u.Joule,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.DsemiDtEqtide": {
            "value": 1.2351242905112555e-10,
            "unit": u.m / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.DeccDtEqtide": {
            "value": 5.8376560316535848e-22,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.DMeanMotionDtEqtide": {
            "value": -1.5221408360256705e-27,
            "unit": 1 / u.sec**2,
            "rtol": 1e-4,
        },
        "log.final.gl514b.DOrbPerDtEqtide": {
            "value": 3.5551108660833393e-14,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EccTimeEqtide": {
            "value": 7.7085733993229242e20,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.SemiTimeEqtide": {
            "value": 5.1112509016620787e20,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.DOblDtEqtide": {
            "value": 3.4502717078725021e-17,
            "unit": u.rad / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.DRotPerDtEqtide": {
            "value": 3.7660242031908285e-11,
            "rtol": 1e-4,
        },
        "log.final.gl514b.DRotRateDtEqtide": {
            "value": -3.1698264008103670e-20,
            "unit": 1 / u.sec**2,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EqRotRateDiscrete": {
            "value": 7.7800437205928784e-07,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EqRotPerDiscrete": {
            "value": 8.0760282754564984e06,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EqRotRateCont": {
            "value": 1.5164601885389768e-06,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EqRotPerCont": {
            "value": 4.1433236128889597e06,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.GammaRot": {
            "value": -1.0000000000000000,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.GammaOrb": {
            "value": -1.0000000000000000,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.EnergyResL": {
            "value": 7.6965989137534052e-11,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.gl514b.EnergyResW": {
            "value": 8.5833562479820102e-11,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.TempLandLat": {
            "value": 545.8665750487864443,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.TempWaterLat": {
            "value": 563.0767544031458556,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.TempMinLat": {
            "value": 520.6587997956706886,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.TempMaxLat": {
            "value": 598.1732888468366127,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.gl514b.TempMaxLand": {
            "value": 657.9980332140348764,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.TempMaxWater": {
            "value": 568.6092758126221725,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.gl514b.PeakInsol": {
            "value": 4243.8792251330123690,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
