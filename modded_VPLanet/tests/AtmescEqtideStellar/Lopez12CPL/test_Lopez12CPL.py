...
@benchmark(
    {
        ...
        "log.initial.star.RotTimeEqtide": {"value": 4.205293e31, "unit": u.sec},
        ...
        "log.initial.auto.EqTidePower": {"value": 1.278596e20, "unit": 1 / u.sec},
        ...
        "log.initial.auto.FXUVCRITDRAG": {
            "value": 3.000221e-05,
            "unit": u.W / u.m**2,
        },
        "log.initial.auto.HREFFLUX": {
            "value": 8.289171e17,
            "unit": 1 / u.m**2 / u.sec,
        },
        "log.initial.auto.XO2": {"value": 0.000000},
        "log.initial.auto.XH2O": {"value": 0.000000},
        "log.initial.auto.HDiffFlux": {
            "value": 3.512237e14,
            "unit": 1 / u.m**2 / u.sec,
        },
        ...
        "log.initial.bondi.EqTidePower": {"value": 1.278596e20, "unit": 1 / u.sec},
        ...
        "log.initial.bondi.FXUVCRITDRAG": {
            "value": 3.000221e-05,
            "unit": u.W / u.m**2,
        },
        "log.initial.bondi.HREFFLUX": {
            "value": 8.289171e17,
            "unit": 1 / u.m**2 / u.sec,
        },
        "log.initial.bondi.XO2": {"value": 0.000000},
        "log.initial.bondi.XH2O": {"value": 0.000000},
        "log.initial.bondi.HDiffFlux": {
            "value": 3.512237e14,
            "unit": 1 / u.m**2 / u.sec,
        },
        ...
        "log.initial.el.EqTidePower": {"value": 1.278596e20, "unit": 1 / u.sec},
        ...
        "log.initial.el.HREFFLUX": {"value": 8.289171e17, "unit": 1 / u.m**2 / u.sec},
        "log.initial.el.XO2": {"value": 0.000000},
        "log.initial.el.XH2O": {"value": 0.000000},
        "log.initial.el.HDiffFlux": {
            "value": 3.512237e14,
            "unit": 1 / u.m**2 / u.sec,
        },
        ...
        "log.initial.rr.EqTidePower": {"value": 1.278596e20, "unit": 1 / u.sec},
        ...
        "log.initial.rr.HREFFLUX": {"value": 8.289171e17, "unit": 1 / u.m**2 / u.sec},
        "log.initial.rr.XO2": {"value": 0.000000},
        "log.initial.rr.XH2O": {"value": 0.000000},
        "log.initial.rr.HDiffFlux": {
            "value": 3.512237e14,
            "unit": 1 / u.m**2 / u.sec,
        },
        ...
        "log.final.auto.FXUVCRITDRAG": {
            "value": 3.177121e-05,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
        "log.final.auto.HREFFLUX": {
            "value": 9.438997e18,
            "unit": 1 / u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.bondi.CrossoverMass": {
            "value": 0.000000,
            "unit": u.kg,
            "rtol": 1e-4,
        },
        "log.final.bondi.WaterEscapeRegime": {"value": 8.000000, "rtol": 1e-4},
        "log.final.bondi.FXUVCRITDRAG": {
            "value": 0.266361,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
        "log.final.bondi.HREFFLUX": {
            "value": 5.387538e16,
            "unit": 1 / u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.el.EccTimeEqtide": {"value": 0.000000, "unit": u.sec, "rtol": 1e-4},
        "log.final.el.SemiTimeEqtide": {"value": 0.000000, "unit": u.sec, "rtol": 1e-4},
        ...
        "log.final.el.FXUVCRITDRAG": {
            "value": 3.010328e-05,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
        "log.final.el.HREFFLUX": {
            "value": 8.735740e17,
            "unit": 1 / u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.rr.EccTimeEqtide": {"value": 0.000000, "unit": u.sec, "rtol": 1e-4},
        "log.final.rr.SemiTimeEqtide": {"value": 0.000000, "unit": u.sec, "rtol": 1e-4},
        ...
        "log.final.rr.FXUVCRITDRAG": {
            "value": 3.000650e-05,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
        "log.final.rr.HREFFLUX": {
            "value": 8.716219e17,
            "unit": 1 / u.m**2 / u.sec,
            "rtol": 1e-4,
        },
