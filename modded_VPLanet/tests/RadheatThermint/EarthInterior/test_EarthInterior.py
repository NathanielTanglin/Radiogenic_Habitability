...
@benchmark(
    {
        ...
        "log.initial.earth.SurfEnFluxTotal": {
            "value": 196.308833,
            "unit": u.kg / u.sec**3,
        },
        ...
        "log.initial.earth.ViscUMan": {"value": 9.025442e07, "unit": u.m**2 / u.sec},
        "log.initial.earth.HZLimitDryRunaway": {"value": 1.358020e11, "unit": u.m},
        ...
        "log.initial.earth.D40KNumManDt": {"value": -1.694596e26, "unit": 1 / u.sec},
        "log.initial.earth.D232ThNumManDt": {"value": -9.534863e23, "unit": 1 / u.sec},
        "log.initial.earth.D238UNumManDt": {"value": -1.408812e24, "unit": 1 / u.sec},
        "log.initial.earth.D235UNumManDt": {"value": -3.089017e24, "unit": 1 / u.sec},
        ...
        "log.initial.earth.SurfEnFluxRadTotal": {
            "value": 0.278724,
            "unit": u.kg / u.sec**3,
        },
        ...
        "log.initial.earth.ViscLMan": {"value": 4.171658e15, "unit": u.m**2 / u.sec},
        ...
        "log.initial.earth.MeltfactorUMan": {"value": 1.925879e07},
        "log.initial.earth.MeltfactorLMan": {"value": 1.000000},
        "log.initial.earth.DepthMeltMan": {"value": 1.503842e06},
        "log.initial.earth.TDepthMeltMan": {"value": 2851.899507},
        "log.initial.earth.TJumpMeltMan": {"value": 1799.978559},
        "log.initial.earth.MeltMassFluxMan": {
            "value": 4.581035e10,
            "unit": u.kg / u.sec,
        },
        "log.initial.earth.ViscUManArr": {
            "value": 1.738191e15,
            "unit": u.m**2 / u.sec,
        },
        "log.initial.earth.RayleighMan": {"value": 3.030360e16, "unit": u.nd},
        "log.initial.earth.ViscMMan": {"value": 9.025442e08, "unit": u.m**2 / u.sec},
        ...
        "log.initial.earth.HflowUMan": {"value": 8.992257e04, "unit": u.TW},
        "log.initial.earth.HfluxLMan": {"value": 0.464167},
        "log.initial.earth.HflowLMan": {"value": 7.067929e13},
        "log.initial.earth.HfluxCMB": {"value": 0.464167},
        "log.initial.earth.HflowCMB": {"value": 70.679290, "unit": u.TW},
        "log.initial.earth.HflowLatentMan": {"value": 2.237044e16},
        "log.initial.earth.HflowMeltMan": {"value": 1.043089e04, "unit": u.TW},
        "log.initial.earth.HflowLatentIC": {"value": 0.000000},
        "log.initial.earth.PowerGravIC": {"value": 0.000000},
        "log.initial.earth.HflowSurf": {"value": 1.003535e17},
        "log.initial.earth.HflowSecMan": {"value": 7.783775e04, "unit": u.TW},
        ...
        "log.initial.earth.MassOC": {"value": 1.941615e24},
        "log.initial.earth.MassIC": {"value": 0.000000},
        "log.initial.earth.MassChiOC": {"value": 1.843482e23},
        "log.initial.earth.MassChiIC": {"value": 0.000000},
        "log.initial.earth.DTChi": {"value": 0.000000},
        "log.initial.earth.CoreBuoyTherm": {
            "value": 4.757325e-12,
            "unit": u.m**2 / u.sec**3,
        },
        "log.initial.earth.CoreBuoyCompo": {
            "value": 0.000000,
            "unit": u.m**2 / u.sec**3,
        },
        "log.initial.earth.CoreBuoyTotal": {
            "value": 4.757325e-12,
            "unit": u.m**2 / u.sec**3,
        },
        ...
        "log.final.earth.SurfEnFluxTotal": {
            "value": 0.065450,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        ...
        "log.final.earth.D26AlNumManDt": {
            "value": 0.000000,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.D40KPowerDt": {"value": -1.000000, "rtol": 1e-4},
        "log.final.earth.D40KNumManDt": {
            "value": -1.425473e25,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.D232ThNumManDt": {
            "value": -7.630893e23,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.D238UNumManDt": {
            "value": -7.013465e23,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.D235UNumManDt": {
            "value": -3.671217e22,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.earth.RadPowerCrust": {
            "value": 6.926650,
            "unit": u.TW,
            "rtol": 1e-4,
        },
        "log.final.earth.RadPowerTotal": {
            "value": 24.322856,
            "unit": u.TW,
            "rtol": 1e-4,
        },
        ...
        "log.final.earth.ViscLMan": {
            "value": 1.183120e18,
            "unit": u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.ShmodUMan": {"value": 3.747198e12, "rtol": 1e-4},
        ...
        "log.final.earth.DepthMeltMan": {"value": 1.015466e05, "rtol": 1e-4},
        "log.final.earth.TDepthMeltMan": {"value": 1590.125195, "rtol": 1e-4},
        "log.final.earth.TJumpMeltMan": {"value": 1239.351897, "rtol": 1e-4},
        "log.final.earth.MeltMassFluxMan": {
            "value": 7.772176e05,
            "unit": u.kg / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.ViscUManArr": {
            "value": 4.929667e17,
            "unit": u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.RayleighMan": {
            "value": 5.235041e06,
            "unit": u.nd,
            "rtol": 1e-4,
        },
        "log.final.earth.ViscMMan": {
            "value": 4.536769e18,
            "unit": u.m**2 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.TDotMan": {
            "value": -9.133773e-16,
            "unit": u.K / u.sec,
            "rtol": 1e-4,
        },
        "log.final.earth.TDotCore": {
            "value": -1.891962e-15,
            "unit": u.K / u.sec,
            "rtol": 1e-4,
        },
        ...
        "log.final.earth.HflowLMan": {"value": 1.344946e13, "rtol": 1e-4},
        "log.final.earth.HfluxCMB": {"value": 0.088326, "rtol": 1e-4},
        "log.final.earth.HflowCMB": {"value": 13.449464, "unit": u.TW, "rtol": 1e-4},
        "log.final.earth.HflowLatentMan": {"value": 1.038850e12, "rtol": 1e-4},
        "log.final.earth.HflowMeltMan": {"value": 0.121851, "unit": u.TW, "rtol": 1e-4},
        "log.final.earth.HflowLatentIC": {"value": 8.208257e12, "rtol": 1e-4},
        "log.final.earth.PowerGravIC": {"value": 3.283303e12, "rtol": 1e-4},
        "log.final.earth.HflowSurf": {"value": 3.345824e13, "rtol": 1e-4},
        ...
        "log.final.earth.DRICDTCMB": {"value": -1.851901e04, "rtol": 1e-4},
        ...
        "log.final.earth.MassOC": {"value": 1.839372e24, "rtol": 1e-4},
        "log.final.earth.MassIC": {"value": 1.022435e23, "rtol": 1e-4},
        "log.final.earth.MassChiOC": {"value": 2.810783e22, "rtol": 1e-4},
        "log.final.earth.MassChiIC": {"value": 1.562404e23, "rtol": 1e-4},
        "log.final.earth.DTChi": {"value": 0.000000, "rtol": 1e-4},
        "log.final.earth.CoreBuoyTherm": {
            "value": 6.166165e-13,
            "unit": u.m**2 / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.earth.CoreBuoyCompo": {
            "value": 8.467345e-13,
            "unit": u.m**2 / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.earth.CoreBuoyTotal": {
            "value": 1.463351e-12,
            "unit": u.m**2 / u.sec**3,
            "rtol": 1e-4,
        },
