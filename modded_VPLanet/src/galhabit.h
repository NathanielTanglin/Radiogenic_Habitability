...
void ReadOptionsGalHabit(BODY *, CONTROL *, FILES *, OPTIONS *, SYSTEM *,
                         fnReadOption[], int);

/* Verify Functions */
// void VerifyPericenter(BODY*,CONTROL*,OPTIONS*,char[],int,int);
void VerifyGalHabit(BODY *, CONTROL *, FILES *, OPTIONS *, OUTPUT *, SYSTEM *,
                    UPDATE *, int, int);
...
void LogGalHabit(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *,
                 fnWriteOutput[], FILE *);
void LogBodyGalHabit(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *,
                     fnWriteOutput[], FILE *, int);

/* GalHabit Functions */
void PropsAuxGalHabit(BODY *, EVOLVE *, IO *, UPDATE *, int);
void ForceBehaviorGalHabit(BODY *, MODULE *, EVOLVE *, IO *, SYSTEM *, UPDATE *,
