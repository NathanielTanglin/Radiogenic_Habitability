...
void ReadOptionsFlare(BODY *, CONTROL *, FILES *, OPTIONS *, SYSTEM *,
                      fnReadOption[], int);

void PropsAuxFlare(BODY *, EVOLVE *, IO *, UPDATE *, int);
void fnForceBehaviorFlare(BODY *, MODULE *, EVOLVE *, IO *, SYSTEM *, UPDATE *,
...
void LogFlare(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *, fnWriteOutput[],
              FILE *);
void LogBodyFlare(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *,
