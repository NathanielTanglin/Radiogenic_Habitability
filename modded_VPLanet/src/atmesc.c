/**
 * Modified atmesc.c. The modifications are in the function
 * fnPropsAuxAtmEsc at line 1733.
 * 
 * 
    @file atmesc.c
...
void InitializeOptionsAtmEsc(OPTIONS *options, fnReadOption fnRead[]) {
  ...
  //FILE *file2 = fopen("magnetic_evolution.csv", "w");

  //if (file != NULL)      
  //  fprintf(file, "eta, FXUV, radius, mass, Ktide,\n");
  
  //if (file2 != NULL)
  //  fprintf(file2, "time,F_AP,beta,planetB,stellarRadius,semimajorAxis,magneticMoment,\n");
