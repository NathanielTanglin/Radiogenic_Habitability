...
void ReadOptionsDistRot(BODY *, CONTROL *, FILES *, OPTIONS *, SYSTEM *,
                        fnReadOption[], int);
void InitializeUpdateTmpBodyDistRot(BODY *, CONTROL *, UPDATE *, int);

/* Verify Functions */
void VerifyDistRot(BODY *, CONTROL *, FILES *, OPTIONS *, OUTPUT *, SYSTEM *,
                   UPDATE *, int, int);
...
void LogDistRot(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *,
                fnWriteOutput[], FILE *);
void LogBodyDistRot(BODY *, CONTROL *, OUTPUT *, SYSTEM *, UPDATE *,
                    fnWriteOutput[], FILE *, int);

/* DistRot Functions */
void PropsAuxDistRot(BODY *, EVOLVE *, IO *, UPDATE *, int);
void ForceBehaviorDistRot(BODY *, MODULE *, EVOLVE *, IO *, SYSTEM *, UPDATE *,
